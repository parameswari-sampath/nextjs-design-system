      ...
      <div className="max-w-4xl w-full">
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex items-center justify-center gap-2 mb-8">
            ...
            <Badge variant="accent">Tailwind CSS v4</Badge>
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <Link href="/sidebar">
              <Button variant="outline" size="lg">View Layouts</Button>
            </Link>
          </div>
        </div>
              ...
              <Card className="h-full hover:shadow-md transition-shadow cursor-pointer">
                <CardContent className="p-6">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="font-medium">Component Samples</span>
                  </div>
              ...
              <Card className="h-full hover:shadow-md transition-shadow cursor-pointer">
                <CardContent className="p-6">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="font-medium">Layout Examples</span>
                  </div>
                  <p className="text-sm text-[var(--color-muted-foreground)] text-left">
